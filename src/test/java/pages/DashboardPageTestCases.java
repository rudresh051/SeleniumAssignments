...
public class DashboardPageTestCases {
	...
	@Test(priority = 22)
	public void TestCaseSideNavigationTrendingUrlsVerify() {
		try {
			DashboardPageVariable.clickOnHamburgerMenuButton();
	...
	public void TestCaseSideNavigationDigitalContentAndDevicesVerify() {
		...
		try {
			DashboardPageVariable.clickOnHamburgerMenuButton();
			wait.until(ExpectedConditions.elementToBeClickable(DashboardPageVariable.amazonMiniTvButton));
			DashboardPageVariable.amazonMiniTvButton.click();
			String url_expected1 = "https://www.amazon.in/minitv?ref_=nav_em_avod_desktop_hamburger_0_1_1_6";
			String url_actual1 = driver.getCurrentUrl();
			Assert.assertEquals(url_actual1, url_expected1);
			driver.navigate().back();
		} catch (Exception e) {
